...
driver = DMRGDriver(scratch="/central/scratch/hczhai/h2d-su2-34-%02d" % fid,
    restart_dir="/central/scratch/hczhai/h2d-34-%02d-mps" % fid,
    symm_type=SymmetryTypes.SU2, stack_mem=100 << 30,
    n_threads=32, n_mkl_threads=4, mpi=True)

bond_dims = [22000] * 4 + [20000] * 4 + [18000] * 4 + [16000] * 4
noises = [0] * 16
thrds = [1E-7] * 16
n_sweeps = 16
...
driver.mpi.barrier()
restart_dir = "/home/hczhai/changroup/work/2d-hubbard/back-pauling/h2d-34-%02d-mps" % pfid

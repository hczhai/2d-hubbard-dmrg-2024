...
driver = DMRGDriver(scratch="/central/scratch/hczhai/h2d-su2-32-%02d" % fid,
    restart_dir="/central/scratch/hczhai/h2d-32-%02d-mps" % fid,
...
driver.mpi.barrier()
restart_dir = "/home/hczhai/changroup/work/2d-hubbard/back-pauling/h2d-32-%02d-mps" % pfid

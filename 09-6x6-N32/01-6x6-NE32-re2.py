...
driver = DMRGDriver(scratch="/scratch/global/hczhai/h2d-su2-32-%02d" % fid,
    restart_dir="/scratch/global/hczhai/h2d-32-%02d-mps" % fid,
...
energy = driver.dmrg(mpo, ket, n_sweeps=n_sweeps, bond_dims=bond_dims, noises=noises, thrds=thrds,
    ...
    dav_max_iter=50, dav_def_max_size=20, sweep_start=0, forward=True)
